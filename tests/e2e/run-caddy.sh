...
assert_grep "$REVIEW_B_HTML" 'rating positive">loved</span>' "rating +3 sentence verb (verb-first form)"
...
assert_grep "$REVIEW_A_HTML" 'rating positive">liked</span>' "review A rating +2 sentence verb"
...
assert_grep "$HOME2_HTML" 'rating positive">liked</span>' "home: rating +2 sentence verb"
assert_grep "$HOME2_HTML" 'rating positive">loved</span>' "home: rating +3 sentence verb"
